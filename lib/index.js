...
RpcClient.callspec = {
  ...
  //omni 
  omni_getbalance:'string float',
  omni_createpayload_simplesend :'int string',
  omni_createrawtx_opreturn :'string string',
  omni_createrawtx_reference :'string string float',
  omni_createrawtx_change :'string string string float float',
  omni_listblocktransactions: 'int int',
  omni_gettransaction: 'string'
};
